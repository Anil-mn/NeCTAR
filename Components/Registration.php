...
function upload($name,$req){
   echo '<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
   <div class="form-group">
   <label class="control-label" for="first-name">'.$name.' *</label>
   <input class="form-control" type="file" name="'.$name.'" required = "'.$req.'">
   </div>
   </div>
   ';
}
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="pLace-order mt-30">
        <button class="view-all-accent-btn disabled" type="submit"  name="submit" >Submit</button>
    </div>
</div>
</div>';
}
