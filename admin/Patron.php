...
select('Role1');
echo '<option value="Patrons">Patrons';
echo '<option value="Advisory">Advisory';
echo '<option value="Technical">Technical';
echo '<option value="Session chairs">Session chairs';
echo $selectEnd;
//input('Role1','text');
input('Role2','text');
