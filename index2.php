...
<body>
    ...
    <div id="wrapper">
       ...
       ?>
        ...
        <div class="slider1-area overlay-default">
            <div class="bend niceties preview-1">
                <div id="ensign-nivoslider-3" class="slides">
                    <img src="img/logo2.png"  alt="slider" title="#slider-direction-1" />
                    <img src="img/slider/WEB.jpg" alt="slider" title="#slider-direction-2" />
                    <img src="img/slider/CON1.jpg" alt="slider" title="#slider-direction-3" />
                </div>
                <div id="slider-direction-1" class="t-cn slider-direction">
                    <div class="slider-content s-tb slide-1">
                        <div class="title-container s-tb-c">
                            <div class="title1">National E-Conference On Technologies Annexing
                                Reality</div>
                            <p></p>
                ...
                <div id="slider-direction-2" class="t-cn slider-direction">
                    <div class="slider-content s-tb slide-2">
                        <div class="title-container s-tb-c">
                            <div class="title1">Commited to people,commited to the future </div>
                            <p>Technology makes our lives easier than what It was. It has made our life much faster.
                                <br> We don’t
                                have to wait for a long time to send and receive letters through the postal service.. </p>
                            <div class="slider-btn-area">
                                <!-- <a href="#" class="default-big-btn">Start a Course</a> -->
                            </div>
                        </div>
                ...
                <div id="slider-direction-3" class="t-cn slider-direction">
                    <div class="slider-content s-tb slide-3">
                        <div class="title-container s-tb-c">
                            <div class="title1">Technology.. it’s everywhere</div>
                            <p>it’s been growing like human population.. We see technological
                                advancements everywhere like in entertainment, healthcare, education
                                <br>, agriculture,
                                photography, business, defense and many more..</p>
                            <div class="slider-btn-area">
                                <!-- <a href="#" class="default-big-btn">Start a Course</a> -->
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="about-page-content-holder">
                            <div class="content-box">
                                <h2>The Reason</h2>
                                <p>Nehru Group of Institutions, is organizing a fully online e-conference on Technologies Annexing
                                    Reality.
                                    Technological annexations have provided our world with new environments and keeps the
                                    human horizons to grow.
                                    ...
                                    photography, business, defense and many more....</div>
                            <div class="content-box">
                                <h2>The Concept</h2>
                                <p>NeCTAR2020: is a virtual conference.. an online event that includes a series of large sessions
                                    run by thought leaders in the industry who present to and interact with attendees. This would
                                    replicate a traditional conference in a virtual environment </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="about-page-img-holder">
                            <img src="img/banner.jpg" class="img-responsive" alt="about">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="about2-area" hidden>
            <div class="container">
                <h1 class="about-title">Welcome To NeCTAR</h1>
                <p class="about-sub-title">Nehru Group of Institutions, is organizing a fully online e-conference on Technologies Annexing
                    Reality.</p>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 wow fadeIn" data-wow-duration="2s" data-wow-delay=".1s">
                        <div class="service-box2">
                            ...
                            <h3><a href="#">The Reason</a></h3>
                            <p>Technology.. it’s everywhere, it’s been growing like human population.. We see technological
                                advancements everywhere like in entertainment, healthcare, education, agriculture,
                                photography, business, defense and many more.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 wow fadeIn" data-wow-duration="2s" data-wow-delay=".4s">
                        <div class="service-box2">
                            ...
                            <h3><a href="#">The Concept</a></h3>
                            <p>NeCTAR2020: is a virtual conference.. an online event that includes a series of large sessions
                                run by thought leaders in the industry who present to and interact with attendees. </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 wow fadeIn" data-wow-duration="2s" data-wow-delay=".7s">
                        <div class="service-box2">
                            ...
                            <h3><a href="#">The Significance</a></h3>
                            <p>Connections among people are better established than the olden
                                time.. Yes.. the technology has made the whole world a global village.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="featured-area bg-common-style" style="background-image: url('img/featured/back.jpg');">
            <div class="container">
                <h2 class="title-default-textPrimary-left">Webinars</h2>
            </div>
            <div class="container">
                <div class="row featured-wrapper" id="gallery-wrapper">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="featured-box">
                            <div class="featured-img-holder hvr-bounce-to-right">
                                <img src="img/featured/cs.jpg" class="img-responsive" alt="featured">
                                <a href="img/featured/cs.jpg" class="zoom"><i class="fa fa-share-alt" aria-hidden="true"></i></a>
                            </div>
                            <div class="featured-content-holder">
                                <h3><a href="webdetails.html">Computational and Information Technologies</a></h3>
                                <p> Dr. Sudheer S Marar PhD</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="featured-box">
                            <div class="featured-img-holder hvr-bounce-to-right">
                                <img src="img/featured/Robo.jpeg" class="img-responsive" alt="featured">
                                <a href="img/featured/Robo.jpeg" class="zoom"><i class="fa fa-share-alt" aria-hidden="true"></i></a>
                            </div>
                            <div class="featured-content-holder">
                                <h3><a href="#">Mechatronics and Robotic Technologies</a></h3>
                                <p> Name</p>
                            </div>
                        </div>
                        <div class="featured-box">
                            <div class="featured-img-holder hvr-bounce-to-right">
                                <img src="img/featured/mec.jpg" class="img-responsive" alt="featured">
                                <a href="img/featured/mec.jpg" class="zoom"><i class="fa fa-share-alt" aria-hidden="true"></i></a>
                            </div>
                            <div class="featured-content-holder">
                                <h3><a href="#">Mechanical and Aeronautical Technologies</a></h3>
                                <p> Name</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="featured-box">
                            <div class="featured-img-holder hvr-bounce-to-right">
                                <img src="img/featured/ec.jpg" class="img-responsive" alt="featured">
                                <a href="img/featured/ec.jpg" class="zoom"><i class="fa fa-share-alt" aria-hidden="true"></i></a>
                            </div>
                            <div class="featured-content-holder">
                                <h3><a href="#">Electronics and Communication Technologies</a></h3>
                                <p> Name</p>
                            </div>
                        </div>
                        <div class="featured-box">
                            <div class="featured-img-holder hvr-bounce-to-right">
                                <img src="img/featured/ag.jpg" class="img-responsive" alt="featured">
                                <a href="img/featured/ag.jpg" class="zoom"><i class="fa fa-share-alt" aria-hidden="true"></i></a>
                            </div>
                            <div class="featured-content-holder">
                                <h3><a href="#">Design and Architectural Innovations</a></h3>
                                <p> Name....</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="view-all-btn-area">
                    <a href="#" class="ghost-btn-big">View All Webinars</a>
                </div>
            </div>
        </div>
        <!-- Courses 1 Area End Here -->
        <!-- Video Area Start Here -->
        <div class="video-area overlay-video bg-common-style" style="background-image: url('img/slider/ncerc1.jpg');">
            <div class="container">
                <div class="video-content">
                    <h2 class="video-title">Watch Campus Life Video Tour</h2>
                    <p class="video-sub-title"></p>
                    <a class="play-btn popup-youtube wow bounceInUp" data-wow-duration="2s" data-wow-delay=".1s" href="https://www.youtube.com/watch?v=ZDldNGJKOBo"><i class="fa fa-play" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        <!-- Video Area End Here -->
        <!-- Lecturers Area Start Here -->
        <div class="lecturers-area" hidden>
            <div class="container">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 counter1-box wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".60s">
                        ...
                        <p>List of accepted submissions</p>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                        <div class="countdown-content">
                            <h1>Next Event</h1>
                            <div class="countdown-date"> On This 01 MAY, 2020</div>
        ...
        <div class="students-say-area">
            <h2 class="title-default-center">messages</h2>
            <div class="container">
                <div class="rc-carousel" data-loop="true" data-items="2" data-margin="30" data-autoplay="false" data-autoplay-timeout="10000" data-smart-speed="2000" data-dots="true" data-nav="false" data-nav-speed="false" data-r-x-small="1" data-r-x-small-nav="false" data-r-x-small-dots="true" data-r-x-medium="2" data-r-x-medium-nav="false" data-r-x-medium-dots="true" data-r-small="2" data-r-small-nav="false" data-r-small-dots="true" data-r-medium="2" data-r-medium-nav="false" data-r-medium-dots="true" data-r-large="2" data-r-large-nav="false" data-r-large-dots="true">
                    <div class="single-item">
                        <div class="single-item-wrapper">
                            <div class="profile-img-wrapper">
                                <a href="#" class="profile-img"><img class="profile-img-responsive img-circle" src="img/students/chairman.jpg"  style="height: 120px;width:120px;;" alt="Testimonial"></a>
                            </div>
                            <div class="tlp-tm-content-wrapper">
                                <h3 class="item-title"><a href="#">Adv. Dr. Krishnadas</a></h3>
                                <span class="item-designation">Chairman and Mg.Trustee NGI</span>
                    ...
                    <div class="single-item">
                        <div class="single-item-wrapper">
                            <div class="profile-img-wrapper">
                                <a href="#" class="profile-img"><img class="profile-img-responsive img-circle" src="img/students/trst.jpg" style="height: 120px;width:120px;" alt="Testimonial"></a>
                            </div>
                            <div class="tlp-tm-content-wrapper">
                                <h3 class="item-title"><a href="#">Dr. Krishnakumar</a></h3>
                                <span class="item-designation">CEO and Secretary NGI</span>
                                <ul class="rating-wrapper">
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                    ...
                    <div class="single-item">
                        <div class="single-item-wrapper">
                            <div class="profile-img-wrapper">
                                <a href="#" class="profile-img"><img class="profile-img-responsive img-circle" src="img/students/principal.png" style="height: 120px;width:120px;"  alt="Testimonial"></a>
                            </div>
                            <div class="tlp-tm-content-wrapper">
                                <h3 class="item-title"><a href="#">Dr. Ambikadevi amma</a></h3>
                                <span class="item-designation">Principal NCERC</span>
                                <ul class="rating-wrapper">
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                    ...
                    <div class="single-item">
                        <div class="single-item-wrapper">
                            <div class="profile-img-wrapper">
                                <a href="#" class="profile-img"><img class="profile-img-responsive img-circle" src="img/students/13.jpg" style="height: 120px;width:120px;" alt="Testimonial"></a>
                            </div>
                            <div class="tlp-tm-content-wrapper">
                                <h3 class="item-title"><a href="#">Dr. Sudheer Marar</a></h3>
                                <span class="item-designation">Associate Professor and HOD
                                    MCA NCERC</span>
                                <ul class="rating-wrapper">
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                    ...
                    <div class="single-item">
                        <div class="single-item-wrapper">
                            <div class="profile-img-wrapper">
                                <a href="#" class="profile-img"><img class="profile-img-responsive img-circle" src="img/students/12.jpg"  style="height: 120px;width:120px;" alt="Testimonial"></a>
                            </div>
                            <div class="tlp-tm-content-wrapper">
                                <h3 class="item-title"><a href="#">Mr. Prasanth P</a></h3>
                                <span class="item-designation">Software Architect
                                    RedBlack Technologies</span>
                                <ul class="rating-wrapper">
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                    ...
                    <div class="single-item">
                        <div class="single-item-wrapper">
                            ...
                            <div class="tlp-tm-content-wrapper">
                                <h3 class="item-title"><a href="#">Person 6</a></h3>
                                <span class="item-designation">Desigination</span>
                                <ul class="rating-wrapper">
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
                                    <li><i class="fa fa-star" aria-hidden="true"></i></li>
        ...
        <div class="students-join1-area" hidden>
            <div class="container">
                <div class="students-join1-wrapper">
                    ...
                    <div class="students-join1-right" hidden>
                        <div>
        ...
        <div class="certificate-area" hidden>
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box">
                                <a href="index.html"><img class="img-responsive" src="img/na.png" alt="logo"></a>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box">
                                ...
                                <ul class="flickr-photos">
                                    <li>
                                        <a href="#"><img class="img-responsive" src="img/featured/Cs.jpg" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="img-responsive" src="img/featured/mec.jpg" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="img-responsive" src="img/featured/Robo.jpeg" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="img-responsive" src="img/featured/medi.jpg" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="img-responsive" src="img/featured/ec.jpg" alt="flickr"></a>
                                    </li>
                                    <li>
                                        <a href="#"><img class="img-responsive" src="img/featured/ag.jpg" alt="flickr"></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
