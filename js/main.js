...
(function($) {
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({ siteLogo: "<a href='index.php' class='logo-mobile-menu'><img src='img/1234.png' style='height:10px;'/></a>" });
    ...
    /*-------------------------------------
     ...
     -------------------------------------*/
    $('#countdown').countdown('2020/04/05', function(e) {
